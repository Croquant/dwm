 ...
 */
//"dina:size=6:antialias=false:autohint=true";
static char *font = "xos4 Terminus:size=9:antialias=false:autohint=true";
static char *font2[] = { "Inconsolata:pixelsize=12:antialias=false:autohint=true" };
